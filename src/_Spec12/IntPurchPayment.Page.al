        ...
        area(Processing)
        {
            ...
            action(DeleteEntries)
            {
                ...
                var
                    ...
                    IntErrors: Record IntegrationErros;
                begin
                    CurrPage.SetSelectionFilter(IntAc);
                    IntAc.CopyFilters(Rec);
                    IntAc.DeleteAll();
                    IntErrors.SetRange("Document No.", Rec."Document No.");
                    IntErrors.SetRange("Integration Type", IntErrors."Integration Type"::"Purchase Payment");
                    if IntErrors.FindFirst() then
                        IntErrors.DeleteAll();
                    CurrPage.Update();
