/// <summary>
/// Table IntegrationPurchaseApply (ID 50071).
/// NGS
/// </summary>
table 50071 "IntPurchPaymentApply"
{
    Caption = 'Integration Purchase Apply';
    ...
    fields
    {
        ...
        field(100; "Line Errors"; Integer)
        {
            ...
            CalcFormula = count(IntPurchPaymentApply where("Excel File Name" = field("Excel File Name"),
                                                            "Status" = filter(2 | 6)));
        }
        field(110; "Errors Import Excel"; Integer)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = count(IntegrationErros where("Integration Type" = filter(7),
