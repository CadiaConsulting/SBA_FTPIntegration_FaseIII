table 50004 "Integration Receipt Journal"
{
    ...
    fields
    {
        ...
        field(100; "Error Order"; Integer)
        {
            ...
            CalcFormula = count("Integration Receipt Journal" where("Document No." = field("Document No."),
                                                            "Status" = filter(2 | 6)));
        }
        field(110; "Errors Import Excel"; Integer)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = count(IntegrationErros where("Integration Type" = filter(12),
