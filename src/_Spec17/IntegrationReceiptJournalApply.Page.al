page 50005 "Integration Rcpt Jnl Apply"
{
    Caption = 'Integration Receipt Journal Apply';
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    SourceTable = "Integration Rcpt Jnl Apply";
    ...
    actions
    {
        area(Processing)
        {
            ...
            {
                ApplicationArea = All;
                Caption = 'Import Excel Receipt Journal Apply';
                Image = CreateDocument;
                ToolTip = 'Import Excel Receipt Journal Apply';
                ...
                begin
                    ImportExcelBuffer.ImportExcelRcptJournalApply();
            ...
            {
                ApplicationArea = All;
                Caption = 'Create Apply';
                Image = CreateDocument;
                ToolTip = 'Create Apply';

                trigger OnAction();
                var
                    IntRecJournalApp: Record "Integration Rcpt Jnl Apply";
                begin
                    CurrPage.SetSelectionFilter(IntRecJournalApp);
                    IntRecJournalApp.CopyFilters(Rec);
                    IntegrationRcptJournalApply.CreateApply(IntRecJournalApp);
                    CurrPage.SaveRecord();
                    CurrPage.Update();
            ...
            action(DeleteEntries)
            {
                ...
                trigger OnAction();
                var
                    IntAc: Record "Integration Rcpt Jnl Apply";
                begin
    ...
    var
        IntegrationRcptJournalApply: codeunit "Integration Rcpt Jnl Apply";
}
